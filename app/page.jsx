                              ...
                              <div style={{ display: 'contents' }}>
                                ...
                                <div className="row" style={{ marginBottom: 12 }}>
                                  ...
                                  {f.noValuation ? (
                                    ...
                                    <div style={{ display: 'contents' }}>
                                      {!(isTradingDay && nowInTz().hour() >= 9 && f.jzrq !== todayStr) && (
                                        <Stat
                                          label="涨跌幅"
                                ...
                                <div className="row" style={{ marginBottom: 12 }}>
                                  {(() => {
                                    const holding = holdings[f.code];
                                    const profit = getHoldingProfit(f, holding);
                                    const principal = (holding?.cost && holding?.share) ? holding.cost * holding.share : 0;
                                        ...
                                        {profit.profitTotal !== null && (
                                          ...
                                          >
                                            ...
                                            <span className={`value ${profit.profitTotal > 0 ? 'up' : profit.profitTotal < 0 ? 'down' : ''}`}>
                                              ...
                                              {percentModes[f.code]
                                                ? `${Math.abs(principal ? (profit.profitTotal / principal) * 100 : 0).toFixed(2)}%`
